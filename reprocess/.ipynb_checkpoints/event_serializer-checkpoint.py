                ...
                if profile>=profiles_lim:
                    ...
                    for mod_cr in mod_crs:                        
                        if mod_cr['file'] == os.path.basename(file):
                            ...
                            mod_cr['mod_profile']=[volt_ch[:,mod_time] for volt_ch in voltage]
                            mod_cr['mod_profile_prev']=[volt_ch[:,mod_time-1] for volt_ch in voltage]
                            mod_cr['mod_profile_next']=[volt_ch[:,mod_time+1] for volt_ch in voltage]
